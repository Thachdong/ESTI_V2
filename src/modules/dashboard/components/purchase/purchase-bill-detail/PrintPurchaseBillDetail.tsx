      ...
      <TableFooter>
        <Box>
          <Typography sx={{ fontSize: "10pt" }}>
            Phiếu nhận hàng được lập thành 02 bản, mỗi bên giữ 01 bản.
          </Typography>
          <Typography sx={{ fontWeight: 600, fontSize: "10pt" }}>
