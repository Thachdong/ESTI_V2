...
export const AdvancePaymentDialogAttach: React.FC = () => {
  ...
  const attachFile = watch("AdvancePaymentAttachFile");
  ...
  const removeFile = useCallback(
    (file: string) => {
      ...
      setValue("AdvancePaymentAttachFile", newFiles);
    },
    [attachFile]
  );
  ...
  const renderTitle = (loading: boolean) => (
    <InputLabel
      disabled={!!loading}
      htmlFor="AdvancePaymentAttachFile"
    ...
    <Box className="flex flex-col mt-4">
      ...
      <Box className="bg-white rounded flex-grow p-3">
        ...
        <FormUploadBase
          controlProps={{
            control,
            name: "AdvancePaymentAttachFile",
          }}
          loader={mainOrder.uploadFile}
