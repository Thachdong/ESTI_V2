    ...
    <Box className="flex flex-col col-span-2">
      ...
      <Box className="bg-white">
        ...
        <List className="border-0 border-t border-solid border-grey-3 px-3">
          <ListItem className="border-0 border-b border-dashed h-[34px] border-grey-3 text-sm flex gap-3 items-center">
          ...
          <ListItem className="text-sm flex gap-3 items-center h-[34px]">
            <span className="font-semibold">
