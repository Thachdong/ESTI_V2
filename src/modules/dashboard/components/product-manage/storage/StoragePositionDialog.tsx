...
import { StoragePosition } from "./StoragePosition";
import { StoragePositionHistory } from "./StoragePositionHistory";

export const StoragePositionDialog: React.FC<TDialog> = ({
  onClose,
  open,
  title,
  refetch,
  ...
  return (
    ...
    >
      ...
      <StoragePosition positionId={defaultValue?.id} open={open} />

      <StoragePositionHistory positionId={defaultValue?.id} open={open} />
    </Dialog>
  );
};
