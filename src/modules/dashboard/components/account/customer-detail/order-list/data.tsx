...
export const orderColumns: TGridColDef[] = [
  ...
  },
  {
    ...
    minWidth: 150,
    renderCell: (params) => _format.getVND(params?.row?.billPaid),
    isSort: false,
    isFilter: false,
  },
  {
    field: "__", // api chưa có
  ...
  },
  {
    ...
    headerName: "Hoa hồng",
    minWidth: 150,
    renderCell: (params) => _format.getVND(params?.row?.commission),
    isSort: false,
    isFilter: false,
  },
  {
    ...
    headerName: "Đã chi",
    minWidth: 150,
    renderCell: (params) => _format.getVND(params?.row?.paidCommission),
    isSort: false,
    isFilter: false,
  },
  {
    ...
    headerName: "Chưa chi",
    minWidth: 150,
    renderCell: (params) => _format.getVND(params?.row?.unPaymentComission),
    isSort: false,
    isFilter: false,
  },
  {
