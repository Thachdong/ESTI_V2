...
export const QuoteRequestDetailPage = () => {
	...
	const { data: requestDetail, refetch } = useQuery(
		['RequestDetail_', id],
		() => preOrderApi.getById(id as string).then((res) => res.data),
		{
			enabled: !!id
		}
	)
	...
	return (
		<Box className="container-center">
			...
			<FormProvider {...method}>
				...
				<QuoteRequestDetailButtons isUpdate={isUpdate} setIsUpdate={setIsUpdate} refetch={refetch} requestDetail={requestDetail} />
			</FormProvider>
		</Box>
	)
}
